    ...
    public partial class nuevabd : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageReservations", x => new { x.PackageId, x.ReservationId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageReservations_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PassengerReservations", x => new { x.PassengerId, x.ReservationId });
                    table.ForeignKey(
                        name: "FK_PassengerReservations_Passengers_PassengerId",
                        column: x => x.PassengerId,
                        principalTable: "Passengers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PassengerReservations_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageReservations_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PassengerReservations_ReservationId",
